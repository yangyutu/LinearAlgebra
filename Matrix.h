...
/** constructor. take the pointer as its start
    */
...
/** construct an empty vector
    */
	...
	_len(0),
	_inc(1) { }
/** shallow copy  an given standard vector
    */
...
/** (shallowly obtain the sub-vector from input index
    */
...
/** transform to matrix with given row number and column number
    */
...
/** shallow contruct Mutable Vector from Vector
    */
	...
	MutableVector()
		:
	Vector() { }
/** contruct Mutable Vector from std::vector
    */
...
/** perform vector a elementwise multiplication vector b  using mkl
    */
...
/** perform elementwise addition using mkl
    */
...
/** perform elementwise division using mkl
    */
	void DivideInto(const Vector & a, const Vector & b);
/** perform elementwise addition using mkl
    */
	void operator+=(const Vector & a);
/** perform elementwise addition of scalar*vector&aInc
    */
...
/** broadcast addition of a constant data
    */
	void operator+=(double d) {
	...
	void Clear() { Assign(0); }
/** Apply the mutator(a function) to every element in the vector itself
    */
	...
	template <class Mutator>
/** Apply the mutator(a function) to every element in the vector a and store it
    */
...
/** back up by standard std::vector
    */
	std::vector<double> _arr;

public:
/** first call the base class constructor then assign memory to 
the _start pointer inherited the base class with given length and initial value
    */
...
/** deep copy assignment, new memory assigned
    */
...
/** shallow assignment, no new memory assigned
    */
...
public:
/** backup by 1D vector of size numR*numC
    */ 
